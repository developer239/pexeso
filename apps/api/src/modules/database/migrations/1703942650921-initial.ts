...
export class Initial1703942650921 implements MigrationInterface {
  name = 'Initial1703942650921'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "game_card" ("id" SERIAL NOT NULL, "gameId" integer NOT NULL, "cardId" integer NOT NULL, "row" integer NOT NULL, "col" integer NOT NULL, "isMatched" boolean NOT NULL, "matchedById" integer, "isFlipped" boolean NOT NULL, CONSTRAINT "PK_b3a1cbc416f2533b795c147eee2" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "game_card" ADD CONSTRAINT "FK_d6902242ce6d83a4f7f95eaa406" FOREIGN KEY ("cardId") REFERENCES "card"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(

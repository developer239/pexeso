...
export class Initial1703867268747 implements MigrationInterface {
  name = 'Initial1703867268747'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "game_player" ("gameId" integer NOT NULL, "userId" integer NOT NULL, "isOnTurn" boolean NOT NULL DEFAULT false, "turnCount" integer NOT NULL DEFAULT '0', "score" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_d230ed89795a91948c09cc6eef5" PRIMARY KEY ("gameId", "userId"))`
    )
    await queryRunner.query(
